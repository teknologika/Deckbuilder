...
class LayoutRecommendationEngine:
    ...
    def _analyze_content_structure(self, content_piece: str) -> Dict[str, Any]:
        ...
        has_list_structure = (bullet_indicators > 2 or content_piece.count('\n') > 2 or 
                             content_piece.count(',') >= 3 or content_piece.count(':') >= 2)
    ...
    def _generate_content_suggestions(
        ...
        if primary_layout.layout == "Four Columns":
            return {
                ...
                "supporting_details": ["distinct categories", "balanced content distribution", "clear labels"],
            ...
            return {
                ...
                "supporting_details": ["contrasting elements", "clear distinctions", "decision factors"],
            ...
            return {
                ...
                "supporting_details": ["complementary topics", "balanced detail level", "related themes"],
