...
class ContentOptimizationEngine:
    ...
    def _optimize_for_comparison(
        ...
        yaml_structure = self._generate_comparison_yaml(
            title, 
            left_content["title"], left_formatted,
            right_content["title"], right_formatted
        )
    ...
    def _apply_content_formatting(self, content: str) -> str:
        ...
        strong_words = ['best', 'fastest', 'highest', 'lowest', 'most', 'least', 'critical', 'important', 'key']
        for word in strong_words:
            content = re.sub(fr'\b({word})\b', r'**\1**', content, flags=re.IGNORECASE)
    ...
    def _generate_four_columns_yaml(self, title: str, columns: List[str]) -> str:
        ...
        for i, col in enumerate(columns):
            ...
            yaml_columns.append(f"""  - title: {col_title}
    content: "{col_content}" """)
...
---"""
    ...
    def _analyze_content_layout_fit(
        ...
        content: str, 
        chosen_layout: str, 
        optimization_result: ContentOptimizationResult
    ) -> GapAnalysis:
    ...
    def _generate_fit_recommendations(
        ...
        if content_fit == "poor":
            recommendations.append(f"Consider switching to a simpler layout like 'Title and Content'")
    ...
    def _get_layout_requirements(self, layout: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "Title and Content": {"min_elements": 1, "max_elements": "unlimited", "flexibility": "very_high"},
