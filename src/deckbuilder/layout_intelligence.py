...
class LayoutIntelligence:
    ...
    def _detect_content_type(self, content_lower: str) -> str:
        ...
        type_mapping = self.intelligence_data.get("content_patterns", {}).get("content_type_mapping", {})
    ...
    def _score_layout(self, analysis: ContentAnalysis, layout_name: str, layout_info: Dict, 
                     content_patterns: Dict, scoring_weights: Dict) -> Tuple[float, List[str]]:
