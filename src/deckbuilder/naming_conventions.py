...
class NamingConvention:
    ...
    def _tier2_powerpoint_types(self, context: PlaceholderContext) -> Optional[SemanticInfo]:
        ...
        return SemanticInfo(
            content_type=type_mapping["type"],
            position=position,
            index=1
        )
    ...
    def _infer_agenda_semantic(self, context: PlaceholderContext, idx: int) -> Optional[SemanticInfo]:
        ...
        agenda_mapping = {
            28: ("number", "item1"), 18: ("content", "item1"),
            29: ("number", "item2"), 20: ("content", "item2"),
            30: ("number", "item3"), 22: ("content", "item3"),
            31: ("number", "item4"), 19: ("content", "item4"),
            32: ("number", "item5"), 21: ("content", "item5"),
            33: ("number", "item6"), 34: ("content", "item6")
        }
