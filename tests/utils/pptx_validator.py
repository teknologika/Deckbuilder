...
class PowerPointValidator:
    ...
    def validate_presentation(self, pptx_path: Path, expected_content: Dict[str, Any],
                            layout_mapping: Optional[Dict[str, Any]] = None,
                            formatting_rules: Optional[Dict[str, Any]] = None) -> ValidationReport:
        """
...
def validate_presentation_file(pptx_path: Path, expected_content: Dict[str, Any],
