...
BUSINESS_CONTENT = {
    ...
    ContentLength.LONG: {
        "titles": ["Comprehensive Quarterly Performance Analysis and Strategic Outlook"],
        "content": [
...
class ContentGenerator:
    ...
    def generate_content_variation(self, base_content: str, length: ContentLength, add_formatting: bool = False) -> ContentVariation:
        ...
        return ContentVariation(text=content, length=length, has_formatting=add_formatting)


# Convenience functions for easy testing
def get_sample_business_content(
...
def get_sample_technical_content(
    length: ContentLength = ContentLength.MEDIUM,
) -> Dict[str, List[str]]:
