...
from src.deckbuilder.path_manager import PathManager, path_manager
...
class TestPathManager:
    ...
    def test_get_template_folder_default(self):
        ...
        assert template_folder == Path.cwd() / "templates"
    ...
    def test_validate_template_exists_true(self):
        ...
        with patch.object(pm, 'get_template_file_path') as mock_path:
            ...
            assert pm.validate_template_exists("test") == True
    ...
    def test_validate_template_exists_false(self):
        ...
        with patch.object(pm, 'get_template_file_path') as mock_path:
            ...
            assert pm.validate_template_exists("test") == False
    ...
    def test_validate_template_folder_exists_true(self):
        ...
        with patch.object(pm, 'get_template_folder') as mock_folder:
            ...
            assert pm.validate_template_folder_exists() == True
    ...
    def test_validate_template_folder_exists_false(self):
        ...
        with patch.object(pm, 'get_template_folder') as mock_folder:
            ...
            assert pm.validate_template_folder_exists() == False
    ...
    def test_validate_assets_exist_true(self):
        ...
        with patch.object(pm, 'get_assets_templates_path') as mock_assets:
            ...
            mock_assets_path.__truediv__ = lambda self, other: mock_pptx if "pptx" in str(other) else mock_json
            mock_assets.return_value = mock_assets_path
            
            assert pm.validate_assets_exist() == True
    ...
    def test_validate_assets_exist_false(self):
        ...
        with patch.object(pm, 'get_assets_templates_path') as mock_assets:
            ...
            assert pm.validate_assets_exist() == False
    ...
    def test_get_version_fallback(self, mock_version):
        ...
        # Should fallback to hardcoded version (currently 1.0.0b3 in development)
        assert version in ["1.0.1", "1.0.0b3"]  # Allow both development and release versions
