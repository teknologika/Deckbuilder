...
class TestStructuredFrontmatterRegistry:
    ...
    def test_build_mapping_rules_four_columns(self, structured_frontmatter_registry):
        ...
        mapping_rules = structured_frontmatter_registry._build_mapping_rules("Four Columns With Titles")
...
class TestStructuredFrontmatterConverter:
    ...
    def test_convert_four_columns_structured_to_placeholders(self, structured_frontmatter_converter, sample_structured_frontmatter):
        """Test converting four columns structured frontmatter."""
        result = structured_frontmatter_converter.convert_structured_to_placeholders(sample_structured_frontmatter)
    ...
    def test_convert_comparison_structured_to_placeholders(self, structured_frontmatter_converter):
        ...
        result = structured_frontmatter_converter.convert_structured_to_placeholders(comparison_data)
    ...
    def test_extract_value_by_path(self, structured_frontmatter_converter):
        ...
        assert structured_frontmatter_converter._extract_value_by_path(data, "comparison.left.title") == "Left Title"
        assert structured_frontmatter_converter._extract_value_by_path(data, "comparison.left.content") == "Left Content"
        
        # Test array access
        assert structured_frontmatter_converter._extract_value_by_path(data, "columns[0].title") == "Col 1"
        assert structured_frontmatter_converter._extract_value_by_path(data, "columns[1].content") == "Content 2"
        
        # Test non-existent paths
        assert structured_frontmatter_converter._extract_value_by_path(data, "nonexistent.path") is None
        assert structured_frontmatter_converter._extract_value_by_path(data, "columns[5].title") is None
    ...
    def test_convert_unsupported_layout(self, structured_frontmatter_converter):
        ...
        result = structured_frontmatter_converter.convert_structured_to_placeholders(unsupported_data)
    ...
    def test_convert_missing_layout(self, structured_frontmatter_converter):
        ...
        result = structured_frontmatter_converter.convert_structured_to_placeholders(data_without_layout)
...
class TestStructuredFrontmatterValidator:
    ...
    def test_validate_four_columns_valid(self, structured_frontmatter_validator, sample_structured_frontmatter):
