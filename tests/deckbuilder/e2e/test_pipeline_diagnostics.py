    ...
    def test_template_layout_placeholder_mapping(self):
        ...
        if mapping_issues:
            ...
            for issue in mapping_issues[:3]:  # Show first 3 issues
                ...
                print(f"  Missing ID: {issue['missing_placeholder_id']} ({issue['placeholder_name']})")
...
class TestContentGenerationDiagnostics:
    ...
    def test_simple_title_slide_content_mapping(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert subtitle_found, f"Subtitle 'TEST SUBTITLE' not found in slide. Found: {slide_text}"
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            for shape in slide.shapes:
                if hasattr(shape, "text_frame") and shape.text_frame.text.strip():
                    ...
                    if "italic" in shape.text_frame.text.lower() and "bold" in shape.text_frame.text.lower():
                        content_found = True
