...
from src.deckbuilder.cli import DeckbuilderCLI
...
class TestCLIPathManagement:
    ...
    def test_cli_environment_setup_template_folder(self):
        ...
        cli = DeckbuilderCLI(templates_path="/custom/templates")
    ...
    def test_init_templates_uses_path_manager(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            with patch.object(path_manager, 'validate_assets_exist') as mock_validate, \
                ...
                with patch('builtins.print') as mock_print:
                    ...
                    assert any("Could not locate template assets" in str(call) 
    ...
    def test_create_presentation_markdown(self, mock_deckbuilder):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.md', delete=False) as temp_md:
            ...
            with patch.object(cli, '_validate_templates_folder', return_value=True):
                try:
                    result = cli.create_presentation(temp_md.name)
    ...
    def test_create_presentation_json(self, mock_deckbuilder):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.json', delete=False) as temp_json:
            temp_json.write('{"presentation": {"slides": [{"type": "Title Slide", "title": "Test"}]}}')
            temp_json.flush()
            ...
            with patch.object(cli, '_validate_templates_folder', return_value=True):
                try:
                    result = cli.create_presentation(temp_json.name)
