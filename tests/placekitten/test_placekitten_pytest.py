...
class TestPlaceKittenIntegration:
    ...
    def test_method_chaining(self, placekitten, test_output_dir):
        ...
        result = (
            placekitten.generate(width=800, height=600, image_id=1)
            .smart_crop(width=400, height=400)
            .apply_filter("grayscale")
            .save(str(test_output_dir / "pytest_method_chaining.jpg"))
        )
...
class TestCleanup:
    ...
    def test_no_root_directory_pollution(self):
        ...
        root_test_files = [
            ...
            if f.is_file() and f.name.startswith("test_") and f.suffix == ".jpg"
        ]
