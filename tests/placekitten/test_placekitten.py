...
def test_smart_cropping():
    ...
    processor = kitten.generate(width=800, height=450, image_id=1)  # 16:9 aspect ratio, 1-based indexing
...
def test_filter_pipeline():
    ...
    for filter_name in filters_to_test:
        processor = kitten.generate(width=400, height=225, filter_type=filter_name, image_id=1)  # 1-based indexing
