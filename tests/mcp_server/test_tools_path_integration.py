...
class TestMCPToolsErrorHandling:
    ...
    def test_missing_template_folder_error(self):
        ...
        with (
            patch.object(path_manager, "get_template_folder", return_value=Path("/nonexistent")),
            patch.object(path_manager, "get_output_folder", return_value=Path("/output")),
        ):
        ...
        with (
            ...
            with (
                ...
                patch.object(
                    ...
                    return_value=Path("/templates/missing.pptx"),
                ),
                patch("mcp_server.tools.os.path.exists", return_value=False),
            ):
...
class TestMCPToolsRealWorldScenarios:
    ...
    def test_analyzer_with_realistic_paths(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with (
                patch.object(path_manager, "get_template_folder", return_value=templates_dir),
