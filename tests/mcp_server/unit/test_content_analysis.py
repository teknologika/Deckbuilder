...
class TestContentAnalyzer:
    ...
    def test_extract_key_messages(self, analyzer):
        ...
        user_input = "We saw 20% growth in revenue, but churn is a problem. Our new strategy will fix this."
    ...
    def test_determine_narrative_arc(self, analyzer):
        ...
        user_input_success = "We had great success, but we have a challenge. Our plan is to solve it."
    ...
    def test_develop_presentation_strategy(self, analyzer):
        ...
        strategy = analyzer._develop_presentation_strategy("persuasive", {"attention_span": "medium", "preferred_format": "balanced"}, "persuade")
