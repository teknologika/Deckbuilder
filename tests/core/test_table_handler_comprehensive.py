...
class TestTableCreation:
    ...
    def test_create_table_with_valid_data(self):
        ...
        # Call the method
        result = self.handler.create_table_from_data(
            self.mock_slide, table_data, position, size
        )
        
        # Verify table was created with correct parameters
        self.mock_shapes.add_table.assert_called_once_with(
            rows, cols, position[0], position[1], size[0], size[1]
        )
    ...
    def test_create_table_with_empty_data(self):
        ...
        result = self.handler.create_table_from_data(
            self.mock_slide, [], (100, 200), (500, 300)
        )
    ...
    def test_create_table_with_invalid_data(self):
        ...
        result = self.handler.create_table_from_data(
            self.mock_slide, invalid_data, (100, 200), (500, 300)
        )
...
class TestFontHandling:
    ...
    def test_validate_font_sizes_boundary_values(self):
        ...
        font_config = {
            "header_font_size": 30,  # Too large
            "data_font_size": 5      # Too small
        }
        
        result = self.handler.validate_font_sizes(font_config)
        expected = {
            "header_font_size": 24,  # Capped at maximum
            "data_font_size": 8      # Raised to minimum
        }
